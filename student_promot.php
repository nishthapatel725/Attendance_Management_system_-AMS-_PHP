...
$rssemto=mysqli_query($con,$selectqry2);
?>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Student Promote</h1>
      <nav>
        <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Admin</a></li>
          <li class="breadcrumb-item">Student Promote</li>
    ...
    <section class="section">
      ...
      <div class="card">
            ...
            <div class="card-body">
            <form method="POST" action="database_studprom.php">
                <br>
              <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">Pramote to</label>
                  <div class="col-sm-3">
                    <select class="form-select" aria-label="Default select example" name="cmb_semto" id="cmb_semto">
                      <option value='0'>Select Semester</option>
                      <?php
                      while($row=mysqli_fetch_row($rssemto))
                      {
                            echo "<option value='$row[0]'>$row[1]</option>";  
                      }
                      ?>                     
  ...
  <script type="text/javascript">
                  function fillstudents()
                  {
                    ...
                    //alert("hi" + course_id + "-" + sem_id );
                    $.ajax({
                        type: 'POST',
                        url: 'studprom_data.php', // Create this PHP file to handle the request
