            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="login.php" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Attandance Management</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Check Your Password</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate action="database_cpwd.php" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="txt_npwd" class="form-control" id="txt_npwd" required>
                      <div class="invalid-feedback">Please enter your password!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="btn_submit" value="submit">Submit</button>
