...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="index.html">Admin</a></li>
          <li class="breadcrumb-item">Assign Rollno</li>
    ...
    <section class="section">
      ...
      <div class="card">
            ...
            <div class="card-body">
            <form method="POST" action="database_generate-rollno.php">
              <br>
              <div class="row mb-3">
  ...
  <script type="text/javascript">
                  function fillstudents()
                  {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'fatchstudent.php', // Create this PHP file to handle the request
